            ...
            do {
                ...
                switch(opcion) { //Uso de switch-case's para seleccionar una opción del menú
                    case 1:
                        ...
                        System.out.println("Cliente regristrado");
                        break;
                    case 2:
                        ...
                        System.out.println("Pedido regristrado");
                        controlador.addPedido(new Pedido(numeroPedido, cantidad , fechaHora, cliente, articulo));
                        break;
                    case 3:
